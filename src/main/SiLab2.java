    ...
    public static List<String> function(List<String> list) {
        ...
        for (int i = 0; i < n; i++) { //8
            if (!list.get(i).equals("#")) { //9
                int num = 0; //10
                if ( (i % rootOfN != 0 && list.get(i - 1).equals("#")) || (i % rootOfN != rootOfN - 1 && list.get(i + 1).equals("#")) ) { //11 levo ili desno
                    if ( (i % rootOfN != 0 && list.get(i - 1).equals("#")) && (i % rootOfN != rootOfN - 1 && list.get(i + 1).equals("#")) ){ //12 i levo i desno
                        num += 2; //13
                    }
                    else { //14
                        num  += 1; //15
